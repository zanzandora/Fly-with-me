...
public class AdminLoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT * FROM admin WHERE NameAdmin = ? AND PasswordAdmin= ?";
            PreparedStatement statement = conn.prepareStatement(sql);
            statement.setString(1, nameAdmin);
            statement.setString(2, passwordAdmin);
            ...
            if (resultSet.next()) {
                ...
                // Đăng nhập thất bại
                response.sendRedirect("admin/admin_login.jsp?error=Invalid email or password");
            }
